...
int main(int argc, char const *argv[]){
    ...
    // test.value.string = "John Doe";

    // // tạo object
    // test.type = JSON_OBJECT;
    // test.value.object.keys = "name";
    // test.value.object.values->type = JSON_STRING;
    // test.value.object.values->value.string = "John Doe";
